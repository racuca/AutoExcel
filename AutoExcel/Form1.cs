    ...
    public partial class Form1 : Form
    {
        ...
        private void btnHelloWorld_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                excelbinder.SaveDocument(Path.Combine(Environment.CurrentDirectory, "testhelloworld.xlsx"));
        ...
        private void btnInsertImage_Click(object sender, EventArgs e)
        {
            ...
            excelbinder.SaveDocument(Path.Combine(Environment.CurrentDirectory, "testinsertimage.xlsx"));
